...
export interface Contract {
  ...
  // preview dirender dari clauses); "upload" = isi kontrak berasal dari berkas
  // yang diunggah user (preview menampilkan berkas itu langsung, bukan hasil
  // render template). Kosong/undefined = "smart" (kontrak lama sebelum field
  // ini ada, perilaku lama tetap jalan).
